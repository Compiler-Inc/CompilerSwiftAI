...
extension CompilerClient {
    ...
    public func processFunction<State: Encodable & Sendable, Parameters: Decodable & Sendable>(_ prompt: String, for state: State) async throws -> [Function<Parameters>] {
        functionLogger.debug("Starting simple processFunction with prompt: \(prompt)")
        let apiKey = "sk_J5YCqNlkILMN15LxVG6Qby6VeduRw2uU3rsx9L8PU"

        let endpoint = "\(baseURL)/v1/function-call/simple/\(appID.uuidString)"
